  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Expertos en madera para construcción y muebles en Orizaba. Ofrecemos la mejor selección de materiales para tus proyectos con entrega a domicilio." />
      </Helmet>
          ...
          <div className="relative max-w-7xl mx-auto px-4 h-full flex items-center">
            <div className="text-white">
              ...
              <p className="text-xl mb-8 max-w-2xl">
                ...
                selección de materiales para tus proyectos con entrega a domicilio.
              </p>
              <Link
                to="/catalogo"
